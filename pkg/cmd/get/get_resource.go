...
func NewGetResourceOptions(cmdFactory cmdutil.Factory, streams genericclioptions.IOStreams) *GetResourceOptions {
...
func (options *GetResourceOptions) CompleteNamespace(args []string, cmd *cobra.Command) error {
...
func getResources(ctx context.Context, options *GetResourceOptions, k8sClient client.Client, resourceListType interface{}) (interface{}, error) {
...
func (options *GetResourceOptions) Run(ctx context.Context, k8sClient client.Client, resourceListType interface{}) error {
	resourceList, err := getResources(ctx, options, k8sClient, resourceListType)
	if err != nil {
		return err
	}
